...
public class UserController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "api.server.error", content = {@Content(mediaType =
                    APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorControllerAdvice.ErrorResponse.class))})
    })
    @GetMapping("list")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "api.user.delete.api-responses.404.description", content =
